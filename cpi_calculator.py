...
.ap-header {
  background:
    radial-gradient(120% 140% at 12% 18%, rgba(225,29,116,0.55) 0%, transparent 42%),
    radial-gradient(120% 140% at 82% 26%, rgba(59,130,246,0.50) 0%, transparent 46%),
    radial-gradient(120% 160% at 94% 88%, rgba(249,115,22,0.42) 0%, transparent 42%),
    radial-gradient(120% 160% at 38% 96%, rgba(200,16,46,0.55) 0%, transparent 46%),
    linear-gradient(135deg, #0C0A12 0%, #14121C 100%);
...
.pill-quarterly { background:rgba(96,165,250,0.18); color:var(--blue); }
...
THEMES = {
    "Dark": {
        ...
        "monthly": "#FF5A73", "quarterly": "#60A5FA",
    ...
    "Light": {
        ...
        "monthly": "#C8102E", "quarterly": "#1D4ED8",
